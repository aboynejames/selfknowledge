...
$(document).ready(function(){
	...
	liveSettings.localURL = "http://localhost/ll/selfknowledge/src/index.html";	
...
//console.log('make recrod time');		
		...
		if(attentionclicktime == "recordtimesave" )
		{
			...
			recordholder['tooltemplate'] = "Worldrecord-template"; //"Individualrecord-template"; //"Worldrecord-template"; 
			...
			var setidentityforrecord = $("form#newrecordtime ul#buildrecordtimetemplate.connectedSortable li").attr("id");	
console.log(setidentityforrecord);
			recordtimein.networkidentity = setidentityforrecord;	
			...
			{			
				...
				livepouch.singleSave(recordholder);	
